package br.com.gatewaysgc.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("br.com.gatewaysgc.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("br.com.gatewaysgc.security.DomainUserDetailsService", "createSpringSecurityUser");
