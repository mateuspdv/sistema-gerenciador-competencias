...
describe('Competency Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'competency', component: CompetencyComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.competencies?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to competencyService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getCompetencyIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getCompetencyIdentifier).toHaveBeenCalledWith(entity);
